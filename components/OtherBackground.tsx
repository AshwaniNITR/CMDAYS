...
export default function OtherBackground() {
  ...
  useEffect(() => {
    ...
    //     const middleOrb = document.getElementById("middle-orbital");

    //     if (middleOrb) {
    //      middleOrb.style.transform =
    // `translateY(${scrollY * 0.18}px) rotate(${scrollY * 0.08}deg)`;
    //     }
    //   };
    let middleAngle = 0;

    const animateMiddleOrbital = () => {
      middleAngle = (middleAngle + 0.15) % 360;

      const middleOrb = document.getElementById("middle-orbital");

      if (middleOrb) {
        middleOrb.style.transform = `translate(-50%, 0px) rotate(${middleAngle}deg)`;
      }

      requestAnimationFrame(animateMiddleOrbital);
    };
   ...
   // window.addEventListener("scroll", handleScroll);
    ...
    const animateAtoms = () => {
      ...
      if (atomRef.current) {
        ...
        electrons.forEach((electron, index) => {
          ...
          const rotatedX = ex * Math.cos(rotation) - ey * Math.sin(rotation);

          const rotatedY = ex * Math.sin(rotation) + ey * Math.cos(rotation);
        ...
        paths.forEach((path, index) => {
          ...
          for (let x = 0; x <= 1440; x += 20) {
            const y =
              80 +
              index * 20 +
              Math.sin((((x + sineOffset) * frequency) / 1440) * Math.PI * 2) *
                amplitude;
            d += `L${x},${y} `;
          }
    ...
    animateAtoms();
    animateSine();
    animateMiddleOrbital();
  }, []);

  return (
    <div className="fixed top-0 left-0 w-full min-h-full overflow-hidden pt-8 md:pt-12 lg:pt-0 pointer-events-none">
      {/* ======================================== */}
      {/* BASE GRADIENT — soft lavender-white-pink  */}
      {/* ======================================== */}
      {/* <div className="fixed inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_0%,rgba(216,180,254,0.55),transparent_70%)]" />
      <div className="fixed inset-0 bg-[radial-gradient(ellipse_50%_50%_at_0%_30%,rgba(167,139,250,0.35),transparent_60%)]" />
      ...
      {/* ======================================== */}
      {/* <div ref={sineRef} className="fixed left-0 right-0 top-[30%] md:top-[35%] lg:top-[38%] opacity-40">
      ...
      <div className="fixed right-[2%] md:right-[5%] top-[25%] md:top-[28%] opacity-60 hidden md:block">
        <svg
          width="180"
          height="75"
          viewBox="0 0 260 90"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="scale-75 md:scale-100 origin-top-right"
        >
          <defs>
          ...
          <path
            d="M0,45 C32,10 65,80 97,45 C130,10 163,80 195,45 C218,20 238,60 260,45"
            stroke="url(#rwG)"
            strokeWidth="2"
            fill="none"
          />
          <path
            d="M0,55 C32,20 65,90 97,55 C130,20 163,90 195,55 C218,30 238,70 260,55"
            stroke="#c084fc"
            strokeWidth="1.2"
            fill="none"
            opacity="0.5"
      ...
      <div
        ref={atomRef}
        className="fixed left-[-40px] md:left-[-50px] lg:left-[-60px] top-[-20px] md:top-[-25px] lg:top-[-30px] scale-75 md:scale-90 lg:scale-100 xl:scale-110 origin-top-left"
      >
        <svg
          width="420"
          height="420"
        ...
        >
          ...
          <path
            d="M190,175 L225,168 L248,190 L245,220 L225,238 L190,238 L172,220 L172,190 Z"
            stroke="rgba(0,0,0,0.18)"
            strokeWidth="1"
            fill="none"
          />
          <path
            d="M210,165 L235,185 L235,235 L210,252 L185,235 L185,185 Z"
      ...
      {/* ======================================== */}
      {/* MIDDLE FLOATING QUANTUM ORBITAL          */}
      {/* ======================================== */}
      <div
        id="middle-orbital"
        className="fixed left-[50%] top-[55vh] -translate-x-1/2 opacity-70 hidden md:block will-change-transform transition-transform duration-75 ease-out pointer-events-none"
      >
        <svg
          width="420"
          height="420"
        ...
        >
          <defs>
            <linearGradient id="midOrb1" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#8b5cf6" stopOpacity="0.15" />
              <stop offset="50%" stopColor="#c084fc" stopOpacity="0.9" />
              <stop offset="100%" stopColor="#ec4899" stopOpacity="0.15" />
            </linearGradient>

            <linearGradient id="midOrb2" x1="100%" y1="0%" x2="0%" y2="100%">
          ...
          {/* DNA style sine strands */}
          <path
            d="M120 120 C180 180 240 240 300 300"
            stroke="#a78bfa"
            strokeWidth="3"
            opacity="0.7"
            strokeLinecap="round"
          ...
          <path
            d="M300 120 C240 180 180 240 120 300"
            stroke="#f472b6"
            strokeWidth="3"
            opacity="0.7"
            strokeLinecap="round"
      ...
      <div
        ref={atomRightRef}
        className="fixed mt-5 right-[-30px] md:right-[-40px] lg:right-[-40px] bottom-[2%] md:bottom-[5%] lg:bottom-[5%] scale-75 md:scale-90 lg:scale-100 xl:scale-110 origin-bottom-right"
      >
        <svg
          width="320"
          height="320"
        ...
        >
          ...
          <circle
            ...
            r="35"
            fill="url(#nucGradR)"
            filter="url(#atomGlowR)"
          />
          <path
            d="M135,125 L158,120 L170,135 L168,160 L158,172 L135,172 L125,160 L125,135 Z"
            stroke="rgba(0,0,0,0.18)"
            strokeWidth="0.8"
            fill="none"
          />
      ...
      {/* ======================================== */}
      <div className="fixed left-[8%] md:left-[14%] lg:left-[18%] top-[2%] md:top-[4%] lg:top-[4%] opacity-25 scale-75 md:scale-90 lg:scale-100 origin-top-left hidden md:block">
        <svg
          width="200"
          height="180"
          viewBox="0 0 200 180"
      ...
      {/* ======================================== */}
      <div className="fixed right-[-30px] md:right-[-20px] lg:right-[-20px] top-[10px] md:top-[15px] lg:top-[20px] scale-75 md:scale-90 lg:scale-100 xl:scale-110 origin-top-right hidden md:block">
        <svg
          width="340"
          height="320"
          viewBox="0 0 340 320"
      ...
      {/* ======================================== */}
      <div className="fixed left-[0%] md:left-[2%] lg:left-[2%] bottom-[2%] md:bottom-[4%] lg:bottom-[8%] scale-75 md:scale-90 lg:scale-100 origin-bottom-left hidden md:block">
        <svg
          width="300"
          height="290"
          viewBox="0 0 300 290"
        ...
        >
          ...
          {/* Front face */}
          <polygon
            points="60,120 200,120 200,240 60,240"
            fill="url(#faceGlass)"
            stroke="#a78bfa"
            strokeWidth="1"
            opacity="0.7"
          ...
          {/* Top face */}
          <polygon
            points="60,120 200,120 240,80 100,80"
            fill="url(#faceGlass)"
            stroke="#a78bfa"
            strokeWidth="1"
            opacity="0.6"
          ...
          {/* Right face */}
          <polygon
            points="200,120 240,80 240,200 200,240"
            fill="url(#faceGlass)"
            stroke="#a78bfa"
            strokeWidth="1"
            opacity="0.5"
      ...
      {/* {[
        ...
        <div key={i} className="fixed hidden sm:block" style={{ left: d.x, top: d.y }}>
      ...
      {/* ======================================== */}
      <div className="fixed left-[10%] md:left-[18%] lg:left-[22%] top-[2%] md:top-[2%] lg:top-[2%] opacity-20 hidden md:block">
      ...
      <div className="fixed right-[10%] md:right-[18%] lg:right-[22%] top-[2%] md:top-[2%] lg:top-[2%] opacity-20 hidden md:block">
        <svg width="140" height="100" viewBox="0 0 140 100">
          {Array.from({ length: 6 }, (_, row) =>
            Array.from({ length: 9 }, (_, col) => (
              <circle
      ...
      <div className="fixed inset-0 pointer-events-none hidden md:block">
        {[
          ...
          <span
            key={i}
            className="fixed rounded-full bg-violet-400/50"
            style={{
              width: p.s,
              height: p.s,
              top: p.t,
      ...
      {/* ======================================== */}
      {/* <div className="fixed inset-0 bg-[radial-gradient(ellipse_55%_55%_at_50%_40%,rgba(255,255,255,0.82),transparent_70%)]" /> */}

      {/* ======================================== */}
      {/* SUBTLE TOP EDGE FADE                      */}
      {/* ======================================== */}
      <div className="fixed top-0 left-0 right-0 h-16 bg-gradient-to-b from-white/30 to-transparent" />
